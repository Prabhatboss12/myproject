...
<body>
    ...
    <div class="container-fluid">
        <div class="row intro py-1" style="background-image: url(img/bg.jpg);">
        ...
        <div class="card-group">
            ...
            <div class="card ">
                ...
                <div class="card-body text-center">
                <img src="img/download.png" alt="transferimg" class="img-fluid">
                <br>
                <br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>Prabhat Upadhyay</b><br>GRIP TheSparksFoundation.</p>
    </footer>
